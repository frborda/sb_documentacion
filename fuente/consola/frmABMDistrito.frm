VERSION 5.00
Begin VB.Form frmABMSecciones 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Secciones Electorales"
   ClientHeight    =   2565
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   7020
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton Buscar 
         ...
         Height          =   855
         Left            =   3735
         Picture         =   "frmABMSecciones.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   0
         Width           =   1245
      ...
      Begin VB.CommandButton Nuevo 
         ...
         Height          =   855
         Left            =   0
         Picture         =   "frmABMSecciones.frx":0102
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   0
         Width           =   1245
      ...
      Begin VB.CommandButton Grabar 
         ...
         Height          =   855
         Left            =   1245
         Picture         =   "frmABMSecciones.frx":0204
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   0
         Width           =   1245
      ...
      Begin VB.CommandButton Borrar 
         ...
         Height          =   855
         Left            =   2490
         Picture         =   "frmABMSecciones.frx":0306
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   0
         Width           =   1245
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.CommandButton Salir 
         ...
         Height          =   855
         Left            =   0
         Picture         =   "frmABMSecciones.frx":0408
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   0
         Width           =   1245
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton cmdPrimero 
         Height          =   325
         Left            =   0
         Picture         =   "frmABMSecciones.frx":050A
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdAnterior 
         Height          =   325
         Left            =   345
         Picture         =   "frmABMSecciones.frx":069C
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   0
         UseMaskColor    =   -1  'True
   ...
   Begin VB.PictureBox Picture4 
      ...
      Begin VB.CommandButton cmdUltimo 
         Height          =   325
         Left            =   345
         Picture         =   "frmABMSecciones.frx":082E
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSiguiente 
         Height          =   325
         Left            =   0
         Picture         =   "frmABMSecciones.frx":09C0
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   0
         UseMaskColor    =   -1  'True
   ...
   Begin VB.Label lblRecordSet 
      ...
      Caption         =   "0/0 Secciones Electorales"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmABMSecciones"
...
Private Sub MostrarRegistro()
    ...
    With Rs
        ...
        If xMax > 0 Then         ' Si hay registros para mostrar
            txtSeccion.Text = .Fields("seccion").Value
            lblRecordSet.Caption = Trim(Str(xPos)) & "/" & Trim(Str(xMax)) & " Secciones Electorales"
        Else                     ' Si no hay registros para mostrar
            Call Limpiar
            lblRecordSet.Caption = "0/0 Secciones Electorales"
        End If
    End With
Exit Sub
TrapError:
...
Private Sub Borrar_Click()
    ...
    If Rs.RecordCount > 0 Then
        xRespuesta = MsgBox("¿Seguro de eliminar la Sección " & UCase(Trim(txtSeccion.Text)) & " de la base de datos?", vbQuestion + vbYesNo)
    ...
    If LCase(strId) <> "nothing" Then
        With Rs
            If .RecordCount > 0 Then
                .MoveFirst
                While blCondicion
                    If Trim(.Fields("seccion").Value) = Trim(strId) Then
                        Call MostrarRegistro
                        blCondicion = False
                    Else
                        .MoveNext
...
Private Sub Grabar_Click()
    ...
    If Trim(txtSeccion.Text) = "" Then
        MsgBox "La Sección Electoral es un dato obligatorio", vbInformation + vbOKOnly
        txtSeccion.SetFocus
        Exit Sub
    Else
        strSeccion = txtSeccion.Text
    End If
    ' ------------------------------------------------------------------------------------
    ...
    With Rs
        If blEsNuevo Then
            .AddNew
        End If
        .Fields("seccion").Value = strSeccion
        .Update
...
Private Sub SetearRs()
    ...
    strSql = "SELECT seccion FROM secciones ORDER BY id_seccion"
