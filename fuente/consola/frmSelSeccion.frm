...
Begin VB.Form frmSelSeccion 
   Caption         =   "Seleccionar Sección Electoral"
   ClientHeight    =   6855
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5985
   ...
   Begin VSFlex7NCtl.VSFlexGrid vsGrilla 
      ...
      FormatString    =   $"frmSelSeccion.frx":0000
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmSelSeccion"
...
Private Sub CargarGrilla()
    ...
    With RsTemp
        If .RecordCount > 0 Then
            ...
            While Not .EOF
                vsGrilla.TextMatrix(xFila, 0) = .Fields("seccion").Value
                xFila = xFila + 1
                .MoveNext
            Wend
        End If
